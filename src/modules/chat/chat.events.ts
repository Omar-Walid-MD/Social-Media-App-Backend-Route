...
export class ChatEvent
{
    ...
    setTyping = (socket: IAuthSocket, io: Server) => {
        return socket.on("setTyping",(data: {typing: boolean; groupId?: string; sendTo?: string;})=>{
            this.chatService.setTyping({...data, socket, io});
        });
    }
}